...
, function(e) {
    e.exports = JSON.parse('{"dialog":{"active":"Activo","always_active":"Siempre activo","change_settings":"Configurar","find_out_more":"<p>Para saber m&aacute;s, visita nuestra p&aacute;gina sobre la <a href=\'%s\' target=\'_blank\'>Pol&iacute;tica de Cookies</a></p>","i_agree_text":"Aceptar","inactive":"Inactivo","ok_text":"OK","text":"<b>Fundación CNSE</b> utiliza cookies propias y terceros (Google Analytics) para mejorar su experiencia de usuario y recoger datos estadísticos sobre el uso de nuestra web por parte de los usuarios. Las cookies se asocian únicamente al navegador que está utilizando, de modo que no se almacena ningún tipo de datos personales sobre el usuario que visita nuestra página web. Para aceptar su uso puede hacer click en el bot&oacute;n &laquo;<b>Aceptar&raquo;</b>. Si usted no est&aacute; de acuerdo, podr&aacute; personalizar sus opciones a trav&eacute;s del bot&oacute;n &laquo;<b>Configurar&raquo;</b>, as&iacute; como revocar o cambiar sus preferencias en cualquier momento.<br/>","title":"Utilizamos cookies"},"level_functionality":{"content":"<p>Estas cookies son utilizadas para proveerte una experiencia m&aacute;s personalizada y recordar tus elecciones en nuestra web.</p><p>Por ejemplo, podemos utilizar cookies de funcionalidad para recordar tus preferencias de idioma o tus detalles de acceso.</p>","title":"Cookies de funcionalidad"},"level_strictly_necessary":{"content":"<p>Estos cookies son esenciales para proveerte los servicios disponibles en nuestra web y para permitirte utilizar algunas caracter&iacute;sticas de nuestra web.</p><p>Sin estas cookies, no podemos proveer algunos servicios de nuestro sitio web.</p>","title":"Cookies estrictamente necesarias"},"level_targeting":{"content":"<p>Estas cookies son utilizadas para ense&ntilde;arte anuncios que pueden ser interesantes basados en tus costumbres de navegaci&oacute;n.</p><p>Estas cookies, servidas por nuestros proveedores de contenido y/o de publicidad, pueden combinar la informaci&oacute;n que ellos recogieron de nuestro sitio web con otra informaci&oacute;n recopilada por ellos en relaci&oacute;n con las actividades de su navegador a trav&eacute;s de su red de sitios web.</p><p>Si eliges cancelar o inhabilitar las cookies de seguimiento y publicidad, seguir&aacute;s viendo anuncios pero estos podr&iacute;an no ser de tu inter&eacute;s.</p>","title":"Cookies de seguimiento y publicidad"},"level_tracking":{"content":"<p>Estas cookies son utilizadas para recopilar informaci&oacute;n, para analizar el tr&aacute;fico y la forma en que los usuarios utilizan nuestra web.</p><p>Por ejemplo, estas cookies pueden recopilar datos como cu&aacute;nto tiempo llevas navegado en nuestro sitio web o qu&eacute; p&aacute;ginas visitas, cosa que nos ayuda a comprender c&oacute;mo podemos mejorar nuestra web para ti.</p><p>La informaci&oacute;n recopilada con estas cookies de rastreo y rendimiento no identifican a ning&uacute;n visitante individual.</p>","title":"Cookies de rastreo y rendimiento"},"preference_center":{"save":"Guardar mis preferencias","title":"Centro de Preferencias de Cookies"},"preference_center_menu_and_content":{"more_information_content":"<h1>M&aacute;s informaci&oacute;n</h1><p>Para cualquier pregunta en relaci&oacute;n con nuestra pol&iacute;tica de cookies y tus preferencias, contacta con nosotros, por favor.</p>","more_information_title":"M&aacute;s informaci&oacute;n","your_privacy_content":"<h1>Tu privacidad es importante para nosotros</h1>\\n<p>Las cookies son peque&ntilde;os archivos de texto que se almacenan en tu navegador cuando visitas nuestra web. Utilizamos cookies para diferentes objetivos y para mejorar tu experiencia en nuestro sitio web (por ejemplo, para recordar tus detalles de acceso).</p><p>Puedes cambiar tus preferencias y rechazar que algunos tipos de cookies sean almacenados mientras est&aacute;s navegando en nuestra web. Tambi&eacute;n puedes cancelar cualquier cookie ya almacenada en tu navegador, pero recuerda que cancelar las cookies puede impedirte utilizar algunas partes de nuestra web.</p>","your_privacy_title":"Tu privacidad"}}')
}
, function(e) {
